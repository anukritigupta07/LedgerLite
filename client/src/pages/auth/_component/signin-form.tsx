...
const SignInForm = ({ className, ...props }: React.ComponentPropsWithoutRef<"form">) => {
          ...
          >
            ...
            <div className="grid gap-4">
              ...
              <Button
                disabled={isLoading}
                type="submit"
                className="w-full bg-[#14A0C4] hover:bg-[#1092B3] text-white font-semibold py-2 rounded-md transition flex items-center justify-center gap-2 animate-slideIn delay-300"
              >
              ...
              {/* Divider */}
              <div className="relative text-center text-sm mt-1 animate-slideIn delay-400">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full bg-[#002B4C] hover:bg-[#00345E] text-white font-medium py-2 rounded-md transition flex items-center justify-center gap-2 animate-slideIn delay-500"
              >
            ...
            {/* Footer */}
            <div className="text-center text-sm text-[#333333]/80 animate-slideIn delay-600">
