      ...
      {categories.map((entry, index) => (
        <div key={`legend-${index}`} className="flex items-center gap-2">
          ...
          <div className="flex justify-between w-full">
            <span className="text-xs font-medium truncate capitalize text-[#002B4C]">
              {entry.name}
            </span>
  ...
  return (
    <Card className="!shadow-none border border-gray-200 bg-white">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg text-[#002B4C]">Expenses Breakdown</CardTitle>
                        ...
                        return (
                          ...
                          >
                            <tspan
                              x={viewBox.cx}
                              y={viewBox.cy}
                              className="fill-[#002B4C] text-2xl font-bold"
                            >
